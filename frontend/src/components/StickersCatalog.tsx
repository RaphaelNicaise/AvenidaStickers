            ...
            <div className="flex items-center justify-between sm:justify-start space-x-4">
              ...
              <div className="flex items-center space-x-3 cursor-pointer group" onClick={onBackToHome}>
                <img 
                  ...
                  className="h-6 w-6 sm:h-8 sm:w-8 object-contain transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6"
                />
                <h1 className="text-lg sm:text-xl font-bold text-primary-700 transition-all duration-300 group-hover:text-primary-800 group-hover:scale-105">
                  Avenida Stickers
                </h1>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center sm:justify-end space-x-2">
              ...
              {onCreatePersonalizedSticker && (
                <button 
                  ...
                  className="group bg-purple-500 hover:bg-purple-600 text-white px-3 sm:px-4 py-2 rounded-lg font-medium 
                ...
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 group-hover:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <button 
                onClick={onViewCart}
                className="group relative bg-primary-500 hover:bg-primary-600 text-white px-3 sm:px-4 py-2 rounded-lg font-medium 
                         transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2
                         hover:scale-105 active:scale-95 transform hover:-translate-y-1"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path 
                    strokeLinecap="round" 
                    strokeLinejoin="round" 
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold
                                 animate-pulse transition-all duration-300 group-hover:scale-125">
